...
ml_save(ml1, "ml1") # works but throws error:
# Warning in gzfile(file, mode) :
# cannot open compressed file 'ml1_2/metadata.rds', probable reason 'No such file or directory'
# Error in gzfile(file, mode) : cannot open the connection
# 3. gzfile(file, mode)
# 2. saveRDS(r, file = file.path(file, "metadata.rds"))
# 1. ml_save(ml1, "ml1_2")
