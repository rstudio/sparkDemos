...
# Cache table
system.time(tbl_cache(sc, "trips_par_joined")) # 4.2 vs 4.3 vs 4.8 min
```
...
model_tbl <- trips_joined_tbl %>%
  ...
  select(tip_amount, fare_amount, vendor_id, pickup_hour, 
         pickup_week, passenger_count, trip_time, trip_distance)
