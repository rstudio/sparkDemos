...
nohup /usr/bin/s3-dist-cp --src=s3n://***/nyc-taxi/csv/nyct2010 --dest=hdfs:///user/rstudio/nyct2010 >> nyct2010.log &
nohup /usr/bin/s3-dist-cp --src=s3n://***/nyc-taxi/parquet_nohead/trips --dest=hdfs:///user/rstudio/trips_par >> trips_par.log &
nohup /usr/bin/s3-dist-cp --src=s3n://***/nyc-taxi/parquet/trips_model_data --dest=hdfs:///user/rstudio/trips_model_data >> trips_model_data.log &
