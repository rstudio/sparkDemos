...
<img src="images/clusterDemo/manager-landing-page.png" width=`r params$width`/>

##Spark 1.6

The default Spark 1.6.0 parcel is in installed and running

<img src="images/clusterDemo/spark-history-server-1.png" width=`r params$width`/>
...
<img src="images/clusterDemo/hue-metastore-1.png" width=`r params$width`/>


# Installation

A fully assembled Spark folder that the RStudio user can access is necessary.  To accomplish this, three steps will be taken: first, is to install Java, second to install Scala and third is assembling Spark. Please note that this installation will not replace the already installed Spark parcel, it will be used to simply make the necessary libraries available to 'sparklyr'.

We will install RStudio and the dependencies in the master node.

### Java 

In a terminal session inside the master node run the following:
...
A Scala version that matches a Spark 1.6.0 assembly is needed, in this case we'll use 2.10.5

```{bash eval=FALSE}
sudo wget http://www.scala-lang.org/files/archive/scala-2.10.5.tgz
...
We will now update the 'bashrc' file to set the Scala version
...
A version that matches the default Spark parcel installed in CDH 5.8.2 will be downloaded and and assembled
...
<p><img src="images/clusterDemo/sign-in-1.png" width=`r params$width`/></p>
...
<p><img src="images/clusterDemo/spark-pane-1.png" width=`r params$width`/></p>

You can inspect your tables by clicking on the data icon.

<p><img src="images/clusterDemo/tables-1.png" width=`r params$width`/></p>

This is what the tables look like loaded in Spark via the History Server Web UI (port 18088)

<p><img src="images/clusterDemo/spark-rdd-1.png" width=`r params$width`/></p>
...
<p><img src="images/clusterDemo/data-analysis-1.png" width=`r params$width`/></p>
...
<p><img src="images/clusterDemo/performance-1.png" width=`r params$width`/></p>
...
<p><img src="images/clusterDemo/forecast-1.png" width=`r params$width`/></p>
...
<img src="images/clusterDemo/flex-1.png" width=`r params$width`/>
