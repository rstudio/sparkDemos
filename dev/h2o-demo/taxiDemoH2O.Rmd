...
# Connect to cluster
sc <- spark_connect(master = "yarn-client", config = conf, version = '1.6.2')
```
...
m3 <- h2o.deeplearning(c("fare_amount", "pay_type", "cab_type", "passenger_count"), "tip_amount", 
trips_train_h2o_tbl)
summary(m3)

trips_train_tbl %>% group_by(pay_type, cab_type) %>% tally
```
